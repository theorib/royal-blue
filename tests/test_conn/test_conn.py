...
from src.connection.connection import connect_db


@pytest.mark.describe("Tests the connections validity")
class TestConnection: 

    @pytest.mark.it("should return a valid connection object when all environment variables are set")
    ...
    @pytest.mark.it("should return an error string if the connection raises a generic exception")
    ...
    @pytest.mark.it("should return a missing environment variable error if DB_USER is missing")
