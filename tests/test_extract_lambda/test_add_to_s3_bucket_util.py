...
class TestS3Functionality:
    def test_add_to_s3_success(self, s3_client):
        ...
        response = add_to_s3_bucket(client=s3_client, bucket_name=bucket, key=key, body=body)
    ...
    def test_add_to_s3_error_responses(self, s3_client, error_code, message):
        ...
        response = add_to_s3_bucket(client=mock_client, bucket_name=bucket, key=key, body=body)
